...
@section('meta_keywords', 'ffxitoolbox, add recipe')
@section('meta_description', '增加合成配方資料表單')
@section('title', $title)
...
<!-- Content Start -->
    ...
    <div class="container">
        ...
        <form action="/recipe/add" method="POST" name="update_form" id="update_form">
            @csrf
        <table width="100%">
            <tr>
                <td colspan="4">
        <label>合成品名：<input type='text' name='name' id='name' placeholder="如：ブロンズダガーx1" size="22"></label>
                </td>
            </tr>
            <tr valign="top">
                <td>
        ...
        <td>
            <label>技能需求：<br />
                    <textarea name='skill' id='skill' cols='15' rows='4' placeholder="合成種類及數值，如：鍛治3，多項分行輸入"></textarea></label>
            </td>
    </tr>
    <tr>
        <td>
        <label>素材1：<input type='text' name='material1' id='material1' placeholder="素材名及數量，數量1時省略" size='22'></label>
        </td>
        <td>
        <label>素材2：<input type='text' name='material2' id='material2' placeholder="素材名及數量，數量1時省略" size='22'></label>
        </td>
        <td>
        <label>素材3：<input type='text' name='material3' id='material3' placeholder="素材名及數量，數量1時省略" size='22'></label>
        </td>
        <td>
        <label>素材4：<input type='text' name='material4' id='material4' placeholder="素材名及數量，數量1時省略" size='22'></label>
        </td>
    </tr>
    <tr>
        <td>
        <label>素材5：<input type='text' name='material5' id='material5' placeholder="素材名及數量，數量1時省略" size='22'></label>
        </td>
        <td>
        <label>素材6：<input type='text' name='material6' id='material6' placeholder="素材名及數量，數量1時省略" size='22'></label>
        </td>
        <td>
        <label>素材7：<input type='text' name='material7' id='material7' placeholder="素材名及數量，數量1時省略" size='22'></label>
        </td>
        <td>
        <label>素材8：<input type='text' name='material8' id='material8' placeholder="素材名及數量，數量1時省略" size='22'></label>
        </td>
    </tr>
</table>
<table width="100%">
    <tr>
        <td>
        <label>HQ1：<input type='text' name='HQ1' id='HQ1'></label>
        </td>
        <td>
        <label>HQ2：<input type='text' name='HQ2' id='HQ2'></label>
        </td>
        <td>
        <label>HQ3：<input type='text' name='HQ3' id='HQ3'></label>
        </td>
    </tr>
</table>
<table width="100%">
    <tr>
        ...
        <label>物品1說明<br /><textarea name='item1' id='item1' cols="50" rows="4" placeholder="在此填入物品說明、性能參數等"></textarea></label>
            </td>
            <td>
        <label>物品2類型
        ...
        <label>物品2說明<br /><textarea name='item2' id='item2' cols="50" rows="4" placeholder="在此填入物品說明、性能參數等"></textarea></label>
            </td>
    </tr>
    <tr>
        <td>
        ...
        <label>物品3說明<br /><textarea name='item3' id='item3' cols="50" rows="4" placeholder="在此填入物品說明、性能參數等"></textarea></label>
            </td>
            <td>
        <label>物品4類型
        ...
        <label>物品4說明<br /><textarea name='item4' id='item4' cols="50" rows="4" placeholder="在此填入物品說明、性能參數等"></textarea></label>
            </td>
    </tr>
</table>
        <p align="center"><button type="submit">送出</button>&nbsp;
            <button type="reset">重寫</button></p>
        </form>
